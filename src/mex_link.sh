...
/usr/pack/matlab-8.3r2014a-fg/bin/matlab -nodesktop -nojvm -nosplash -r "mex CFLAGS='-Wall -fpic -std=c++11'  ${SOURCEPATH}/mex_stub.cpp -L./ -l$STATIC_LIB_NAME -L$CERES_LIB_PATH $CERES_LIBS -output $STATIC_LIB_NAME;  exit"
